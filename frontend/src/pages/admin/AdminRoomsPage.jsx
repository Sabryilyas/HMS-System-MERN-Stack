          ...
          <Card className="p-8 mb-12 bg-white shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Branch Location (Optional)</label>
                  <select
                    name="branch"
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-gray-200 bg-gray-50">
                  ...
                  <th className="text-left py-4 px-4 font-semibold text-gray-900">Branch</th>
                ...
                {rooms.map((room) => (
                  <tr key={room._id} className="border-b border-gray-200 hover:bg-gray-50 transition">
                    ...
                    <td className="py-4 px-4 text-gray-900">
                      <span className="line-through text-gray-400">{Math.round(room.price).toLocaleString('en-US')} LKR</span>
                    </td>
                    <td className="py-4 px-4 text-gray-900 font-bold">{Math.round(room.discountPrice).toLocaleString('en-US')} LKR</td>
